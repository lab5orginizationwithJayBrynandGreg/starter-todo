...
class Mtce extends Application {
	...
	private function showit()
	{
		...
		$fields = array(
			...
			'fsize' => makeTextField('Size', 'size',$task->size, 'Size', "how big is the task"),
			'fgroup' => makeTextField('Group', 'group', $task->group, 'Group', "which group is the task in"),
			'fstatus' =>  makeTextField ('Status', 'status', $task->status,'Status', 'what is the current state'),
